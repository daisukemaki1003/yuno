...
export default function OutlineButton({
  ...
  const variantClasses = {
    primary: "border-blue-500 text-blue-500 hover:bg-blue-50 focus:ring-blue-500",
    secondary: "border-gray-300 text-gray-700 hover:bg-gray-50 focus:ring-gray-500",
